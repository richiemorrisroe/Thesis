...
placmod.first.fit <- sem(placmod.first.mod, data=na.omit(exp.sem), start="Mplus")
placmod.kirsch.fit <- sem(placmod.kirsch.mod, data=na.omit(exp.sem))
placmod.cred.opt.fit <- sem(placmod.cred.opt.mod, data=na.omit(exp.sem))
@ 
