...
@   
  \caption{Scatterplots and Correlations for Implicit and Explicit Measures. Upper triangle shows the correlations, lower triangle shows the scatterplots, Diagonal shows the distributions}
...
print(xtable(apareg(glm(PlacResp~AbilityConv+AbilityAlt, data=Iatandexpmeasures.grmtcq, family=binomial(link="logit")), logistic=TRUE), caption="Regression of Conventional TCQ Summary Scores on Placebo Response", label="tab:placmodirtest"))
@ 
