...
@  
  \caption{TCQ IAT Stimuli Response Times in Block 3. Each density plot represents the distribution of each participants' response times. Plot is truncated at 5000ms to show majority of responses clearly}
...
stimreal3.pl <- ggplot(tcqstimreal3.m, aes(x=Block3, y=value))+geom_boxplot()
stimreal5.pl <- ggplot(tcqstimreal5.m, aes(x=Block5, y=value))+geom_boxplot()
...
tcqstimconv3pl <- ggplot(tcqstim3conv.m, aes(x=Block3, y=value))+geom_boxplot()
tcqstimconv5pl <- ggplot(tcqstim5conv.m, aes(x=Block5, y=value))+geom_boxplot()
...
print(plotmatrix(optstimblock3)+geom_smooth(method="lm"))
@ 
...
<<optstimblock5, echo=FALSE, fig=TRUE,pdf=TRUE, eps=TRUE, png=TRUE>>=
print(plotmatrix(optstimblock5)+geom_smooth())
@ 
...
\begin{figure}
<<experimentoptimism, echo=FALSE, fig=TRUE,pdf=TRUE, eps=TRUE, png=TRUE>>=
...
\begin{figure}
<<experimentmindfulness, echo=FALSE, fig=TRUE,pdf=TRUE, eps=TRUE, png=TRUE>>=
...
\begin{figure}
<<experimentpill, echo=FALSE, fig=TRUE,pdf=TRUE, eps=TRUE, png=TRUE>>=
...
\begin{figure}
<<experimentcream, echo=FALSE, fig=TRUE,pdf=TRUE, eps=TRUE, png=TRUE>>=
...
\begin{figure}
<<expinj, echo=FALSE, fig=TRUE,pdf=TRUE, eps=TRUE, png=TRUE>>=
...
\begin{figure}
<<alttreatmentsexp, echo=FALSE, fig=TRUE,pdf=TRUE, eps=TRUE, png=TRUE>>=
