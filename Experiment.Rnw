...
<<impexpmod, echo=FALSE, results=hide>>=H
...
print(xtable(placmod.fit.all, label="tab:placmodsemfit", caption="Fit Measures for Placebo Response Structural Equation Models"), scalebox=0.7)
@ 
