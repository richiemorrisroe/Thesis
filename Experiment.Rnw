...
\item It has been suggested that the IAT captures substantial state variance (as evidenced by low test-retest reliability) \cite{Egloff2005} and it has also been argued that response to placebo is similar, thus suggesting that there may be a link~\cite{Whalley2008}
