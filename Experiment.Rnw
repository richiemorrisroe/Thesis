...
gend.gsr.pl <- ggplot(na.omit(gsr.gend.m2), aes(x=index, y=value, colour=variable))+geom_line()+geom_smooth()+xlab("Time")
gsr.placresp.m2 <- gsr.placresp.m[with(gsr.placresp.m, index<=2000),]
placresp.gsr.pl <- ggplot(gsr.placresp.m2, aes(x=index, y=value, colour=variable))+geom_line()+geom_smooth()
...
print(ggplot(gsr.conditions.m2, aes(x=index, y=value, colour=variable))+geom_line()+geom_smooth()+xlab("Time"))
@   
...
print(ggplot(cond.m2, aes(x=index, y=value, colour=variable))+geom_line())
@   
