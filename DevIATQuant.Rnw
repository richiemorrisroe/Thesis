...
@  
  \caption{Pairs Plot of Explicit Variables, Pilot Study. LOTR: Life Orientation Test, Revised. MAAS - Mindful Attention Absorption Scale. Pill - Pill Credibility. Cream - Cream Credibility. Inj - Injection Credibility. Acu - Acupuncture Credibility. Hom - Homeopathy Credibility. Rei - Reiki Credibility}
...
print(ggplot(vas.m, aes(x=Time, y=Pain, colour=Participant))+geom_line()+xlab("Time")+ylab("Self Reported Pain"))
@  
  \caption{Participant pain responses over time}
