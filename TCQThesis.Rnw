...
The item-splitting procedure suggests that there are two scales, one for conventional items and another for alternative items, as was seen in the previous two splits. The assumption checking will therefore be carried out on each scale seperately. 
...
There were no violations of the item ordering or monotonicity assumptions in this split. 
...
All of the items in the TCQ conventional scale met the IIO and monotonicity assumptions.
