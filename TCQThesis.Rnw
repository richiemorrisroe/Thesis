...
## bam2cgpcm.raschplot <- ggplotGRM(coef2mat(coef(bam2c.gpcm.rasch)))
% @                               %
...
## <<bam2dgpcmraschplot, echo=FALSE, fig=TRUE>>=
## bam2dgpcm.raschplot <- ggplotGRM(na.omit(coef2mat(coef(bam2d.gpcm.rasch))))
% @                               %
...
pilltot.step.nota <- stepAIC(object=pilltotlm1, upper=pilltotlm1,lower=~1, direction="both", k=3)
print(xtable(summary(pilltot.step.nota)))
pilltot.pred <- predict(pilltotlm1, newdata=tcq2a)
@
...
tcq2nota.full <- complete.cases(tcq2nota)
tcq2nota.complete <- tcq2nota[tcq2nota.full,]
creamtotlm1 <- lm(Creamtot~Pilltot+Injtot+Acutot+Homtot+Reitot+Expalt+Expconv+Gender+Income+Health, data=tcq2nota.complete)
creamtot.step.nota <- stepAIC(object=creamtotlm1, upper=creamtotlm1,lower=~1, direction="both", k=3)
print(xtable(summary(creamtot.step.nota), label="tab:creamtotlm1nota"))
creamtot.pred <- predict(creamtotlm1, newdata=tcq2a)
@
...
tcq2nota.full <- complete.cases(tcq2nota)
tcq2nota.complete <- tcq2nota[tcq2nota.full,]
injtotlm1 <- lm(Injtot~Creamtot+Pilltot+Acutot+Homtot+Reitot+Expalt+Expconv+Gender+Income+Health, data=tcq2nota.complete)
injtot.step.nota <- stepAIC(object=injtotlm1, upper=injtotlm1,lower=~1, direction="both", k=3)
print(xtable(summary(injtot.step.nota), label="tab:injtotlm1nota"))
injtot.pred <- predict(injtotlm1, newdata=tcq2a)
@ 
...
tcq2nota.full <- complete.cases(tcq2nota)
tcq2nota.complete <- tcq2nota[tcq2nota.full,]
acutotlm1 <- lm(Acutot~Creamtot+Pilltot+Injtot+Homtot+Reitot+Expalt+Expconv+Gender+Income+Health, data=tcq2nota.complete)
acutot.step.nota <- stepAIC(object=acutotlm1, upper=acutotlm1,lower=~1, direction="both", k=3)
print(xtable(summary(acutot.step.nota), label="tab:acutotlm1nota"))
acutot.pred <- predict(acutotlm1, newdata=tcq2a)
@ 
...
tcq2nota.full <- complete.cases(tcq2nota)
tcq2nota.complete <- tcq2nota[tcq2nota.full,]
homtotlm1 <- lm(Homtot~Creamtot+Pilltot+Injtot+Acutot+Reitot+Expalt+Expconv+Gender+Income+Health, data=tcq2nota.complete)
homtot.step.nota <- stepAIC(object=homtotlm1, upper=homtotlm1,lower=~1, direction="both", k=3)
print(xtable(summary(homtot.step.nota), label="tab:homtotlm1nota"))
acutot.pred <- predict(acutotlm1, newdata=tcq2a)
@ 
...
tcq2nota.full <- complete.cases(tcq2nota)
tcq2nota.complete <- tcq2nota[tcq2nota.full,]
reitotlm1 <- lm(Reitot~Creamtot+Pilltot+Injtot+Acutot+Reitot+Expalt+Expconv+Gender+Income+Health, data=tcq2nota.complete)
reitot.step.nota <- stepAIC(object=reitotlm1, upper=reitotlm1,lower=~1, direction="both", k=3)
print(xtable(summary(reitot.step.nota), label="tab:reitotlm1nota"))
reitot.pred <- predict(reitotlm1, newdata=tcq2a)
@ 
...
bamtotlm1 <- lm(Bamtot~Creamtot+Pilltot+Injtot+Acutot+Reitot+Expalt+Expconv+Gender+Income+Health, data=tcq2nota.complete)
bamtot.step.nota <- stepAIC(object=bamtotlm1, upper=bamtotlm1,lower=~1, direction="both", k=3)
print(xtable(summary(bamtot.step.nota), label="tab:bamtotlm1nota"))
bamtot.pred <- predict(bamtotlm1, newdata=tcq2a)
@ 
...
pilltot.step.notb <- stepAIC(object=pilltotlm1.notb, upper=pilltotlm1notb,lower=~1, direction="both", k=3)
pilltot.pred <- predict(pilltotlm1, newdata=tcq2b)
...
creamtot.pred <- predict(creamtotlm1, newdata=tcq2b)
...
injtot.pred <- predict(injtotlm1, newdata=tcq2b)
...
acutot.pred <- predict(acutotlm1, newdata=tcq2b)
...
homtot.pred <- predict(homtotlm1, newdata=tcq2b)
...
reitotlm1.notc <- lm(Reitot~Creamtot+Injtot+Acutot+Homtot+Reitot+Expalt+Expconv+Gender+Income+Health, data=tcq2notc.complete)
reitot.step.notc <- stepAIC(object=reitotlm1.notc, upper=reitotlm1notc,lower=~1, direction="both", k=3)
reitot.pred <- predict(reitotlm1, newdata=tcq2c)
print(xtable(summary(reitot.step.notc)), label="tab:reitotnotcsteplm")
@ 
Table \ref{tab:reitotnotcsteplm} shows the estimated best model from the training set. The model is smaller than usual, but all the coefficients have the expected sign. The performance of this model was then applied to the training set. 
...
pilltot.pred <- predict(pilltotlm1, newdata=tcq2c)
...
creamtot.pred <- predict(creamtotlm1, newdata=tcq2c)
...
injtot.pred <- predict(injtotlm1, newdata=tcq2c)
...
acutot.pred <- predict(acutotlm1, newdata=tcq2c)
...
homtot.pred <- predict(homtotlm1, newdata=tcq2c)
...
pilltot.pred <- predict(pilltotlm1, newdata=tcq2d)
...
creamtot.pred <- predict(creamtotlm1, newdata=tcq2d)
