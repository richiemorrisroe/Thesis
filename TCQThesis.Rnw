...
tcq2dFit5 <- FitIndices(tcq2d.fact.5)
tcq2dFit6 <- FitIndices(tcq2d.fact.6)
tcq2dFit7 <- FitIndices(tcq2d.fact.7)
tcq2dfit <- as.data.frame(cbind(tcq2dFit5, tcq2dFit6, tcq2dFit7))
...
print(FactorXtab(bam2d.fact2))
@ 


<<bam2dfact2dor, echo=FALSE, results=tex>>=
print(FactorCor(bam2d.fact2))
@ 
