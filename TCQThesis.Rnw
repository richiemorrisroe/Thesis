...
In light of evidence that the IAT correlates better with explicit measures when they are relative measures (i.e. a feeling thermometer) than when they are not, a non-relative measure was adapted for this research, to maximise the incremental validity of each measure. 
