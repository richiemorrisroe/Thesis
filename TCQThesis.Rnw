...
print(xtable(fit.tcq1.m, caption="Fit Indices, TCQ 1", label="tab:tcq1modelcomp"), scalebox=0.6)
@ 
...
As can be seen from \Table \ref{tab:tcq1pilllmsum}, there were no significant predictors of Pill Credibility scores from amongst the demographic variables collected in Study One. 
