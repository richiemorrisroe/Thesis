...
xtab.coll<-xtable(sum.coll.mat, label="tab:tcq1.college", caption="College of Respondents, TCQ 1")
print(xtab.coll)
@ 
...
xtab.ugpg<-xtable(ugpg.mat, caption="Distribution of Undergraduates and Postgraduate Respondents, TCQ 1", label="tab:tcq1ugpg")
print(xtab.ugpg)
@ 
...
xtab.totals<-xtable(mat.totals, caption="Summary Statistics, Total Credibility Scores", label="tab:tcq1.sumtotals")
print(xtab.totals)
@ 
...
print(FactorXtab(tcq.fact.4, label="tcqfact4", caption="Four Factor Solution, TCQ 1 Oblimin rotation"))
@ 
...
print(FactorCor(tcq.fact.4, label="factorcor4", caption="Four Factor TCQ correlations"))
@ 
...
print(FactorXtab(tcq.fact.5, label="tcqfact5",caption="Five Factor Solution, TCQ 1 Promax rotation"))
@ 
<<tcq5cor, echo=FALSE, results=tex>>=
print(FactorCor(tcq.fact.5, label="tcq5cor", caption="Five Factor Solution TCQ1 Correlations"))
@ 
...
print(FactorXtab(tcq.fact.6, label="tcqfact6", caption="Six Factor Solution, TCQ 1, Oblimin Rotation"))
@ 
<<tcq6cor, echo=FALSE, results=tex>>=
print(FactorCor(tcq.fact.6, label="tcq6cor",caption="TCQ Six Factor Solution Correlations"))
@ 
...
print(xtable(fit.tcq1, caption="Fit Indices, TCQ 1", label="tab:tcq1modelcomp"))
@ 
...
print(xtable(tcq2.sum, caption="Demographic Statistics, TCQ 2", label="tab:tcq2demo"))
@ 
...
print(xtable(gendcred, caption="Credibility Differences by Gender", label="tab:tcq2.collegecred"))
@ 
...
print(FactorXtab(tcq2a.fact.6, label="tcq2afact6", caption="Six factor Solution, TCQ 2, Oblimin Rotation"))
@ 
...
print(FactorCor(tcq2a.fact.6, label="tcq2afactorcor", caption="Factor Correlations, Six Factor Solution TCQ 2"))
@ 
...
print(FactorXtab(tcq2a.fact.7, label="tcq2afact7",caption="Seven Factor Solution, TCQ 2, Oblimin Rotation"))
@ 
...
print(xtable(tcq2afit,caption="Fit Indices, TCQ 2", label="tab:tcq2.fit"))
@ 
...
print(FactorXtab(tcq2b.fact.5, label="tcq2afact5",caption="Five factor Solution, TCQ 2 (Split B), Oblimin Rotation"))
@ 
...
Below can be seen the correlations between factors, in Table \ref{tab:tcq2.sixfactorcorr} 
<<tcq2afactorcor, echo=FALSE, results=tex>>=
print(FactorCor(tcq2a.fact.6,label="tcq2afactorcor",caption="Factor Correlations, Six Factor Solution TCQ 2A"))
@ 
...
print(FactorXtab(tcq2b.fact.7, label="tcq2afact7",caption="Seven Factor Solution, TCQ 2, Oblimin Rotation"))
@ 
...
print(FactorXtab(tcq2c.fact.5,label="tcq2cfact5",caption="Five factor Solution, TCQ 2 (Split B), Oblimin Rotation"))
@ 
...
print(FactorXtab(tcq2c.fact.6,label="tcq2cfact6",caption="Six factor Solution, TCQ 2, Oblimin Rotation"))
@ 
...
print(FactorCor(tcq2c.fact.6,label="tcq2c6factorcor",caption="Factor Correlations, Six Factor Solution TCQ 2C"))
@ 
...
print(FactorXtab(tcq2c.fact.7,label="tcq2cfact7",caption="Seven Factor Solution, TCQ 2, Oblimin Rotation"))
@ 
...
print(xtable(tcq2cfit,caption="Fit Indices, TCQ 2 (Split C)", label="tab:tcq2cfit"))
@ 
...
print(FactorXtab(tcq2d.fact.6,label="tcq2dfact6",caption="Six factor Solution, TCQ 2(Split D), Oblimin Rotation"))
@ 
...
print(FactorCor(tcq2d.fact.6,label="tcq2dfactorcor",caption="Factor Correlations, Six Factor Solution TCQ 2 (Split D)"))
@ 
...
print(FactorXtab(tcq2d.fact.7,label="tcq2dfact7",caption="Seven Factor Solution, TCQ 2, Oblimin Rotation (Split D)"))
@ 
...
print(xtable(tcq2dfit,caption="Fit Indices, TCQ 2 (Split D)",label="tab:tcq2dfit"))
@ 
...
print(xtable(coef2mat(coef(bam2b.grm.1pl)), label="tab:bam2bgrm1sum"))
@ 
...
print(xtable(coef2mat(coef(bam2b.grm.2pl)), label="tab:bam2bgrm2sum"))
@ 
...
tcq2c.conv.gutt.plot <- ggplot(as.data.frame(tcq2c.conv.gutt), aes(x=tcq2c.conv.gutt))+layer(geom="bar", binwidth=5)
...
print(xtable(coef2mat(coef(bam2c.grm.1pl)), label="tab:bam2cgrm1sum"))
@ 

Table \ref{tab:bam2cgrm1sum} shows that there are no monotonicity problems with the one parameter GRM. The estimated dsicrimination parameter is 1.523, and BAM6 appears to be the most difficult item in the scale (as no participants gave the highest response category to it, across all of the splits).




<<bam2cgrm2sum, echo=FALSE, results=tex>>=
print(xtable(coef2mat(coef(bam2c.grm.2pl)), label="tab:bam2cgrm2sum"))
@ 
...
print(xtable(tcq2d.aisp), label="tab:tcq2daisp")
@ 
...
print(xtable(tcq2d.conv.iio$violations, label="tab:tcq2dcheckiio"))
@ 
...
print(xtable(summary(tcq2d.conv.mono), label="tab:tcq2dconvcheckmono"))
@ 
...
tcq2d.conv.gutt.plot <- ggplot(as.data.frame(tcq2d.conv.gutt), aes(x=tcq2d.conv.gutt))+layer(geom="bar", binwidth=5)
...
print(xtable(tcq2d.alt.iio$violations, label="tab:tcq2daltcheckiio"))
@ 
...
print(xtable(summary(tcq2d.alt.mono), label="tab:tcq2daltcheckmono"))
@ 
...
print(xtable(coef(tcq2d.conv.grm.1pl), label="tab:tcq2dconvgrm1plsumm"))
@ 
...
print(xtable(coef(tcq2d.conv.grm.2pl), label="tab:tcq2dconv2plgrmsum"))
@ 
...
print(xtable(bam2d.aisp, label="tab:bam2daisp"))
@ 
...
print(xtable(bam2d.iio$violations, label="tab:bam2dheckiio"))
@ 
...
print(xtable(summary(bam2d.mono), label="tab:bam2dcheckmono"))
@ 
...
bam2d.guttplot <- ggplot(as.data.frame(bam2d.guttman), aes(x=bam2d.guttman))+layer(geom="bar", binwidth=2)
...
print(xtable(coef2mat(coef(bam2d.gpcm.rasch)), label="tab:bam2dgpcmrasch"))
@ 
...
print(xtable(coef2mat(coef(bam2d.grm.1pl)), label="tab:bam2dgrm1sum"))
@ 
...
print(xtable(coef2mat(coef(bam2d.grm.2pl)), label="tab:bam2dgrm2sum"))
@ 
...
print(xtable(summary(pilltot.step.nota)))
...
print(xtable(summary(pilltotlm.holdout)))
@ 
...
print(xtable(summary(creamtot.step.nota), label="tab:creamtotlm1nota"))
...
print(xtable(summary(creamtotlm.holdout), label="tab:creamlmholdoutnota"))
@ 
...
print(xtable(summary(injtot.step.nota), label="tab:injtotlm1.notanota"))
...
print(xtable(summary(injtotlm.holdout), label="tab:injlmholdoutnota"))
@ 
...
print(xtable(summary(acutot.step.nota), label="tab:acutotlm1.notanota"))
...
print(xtable(summary(Acutotlm.holdout), label="tab:aculmholdoutnota"))
@ 
...
print(xtable(summary(homtot.step.nota), label="tab:homtotlm1.nota"))
acutot.pred <- predict(acutotlm1.nota, newdata=tcq2a)
@ 
...
print(xtable(summary(Homtotlm.holdout), label="tab:homlmholdoutnota"))
@ 
...
print(xtable(summary(reitot.step.nota), label="tab:reitotlm1nota"))
...
print(xtable(summary(Reitotlm.holdout), label="tab:reilmholdoutnota "))
@ 
...
print(xtable(summary(bamtot.step.nota), label="tab:bamtotlm1nota"))
...
print(xtable(summary(Bamtotlm.holdout), label="tab:Bamlmholdoutnota"))
@ 
...
print(xtable(summary(pilltot.step.notb)), label="tab:pilltotnotbsteplm")
@ 
...
print(xtable(summary(pilltotnotb.heldout.lm), label="tab:pilltotnotbheldout"))
@ 
...
print(xtable(summary(creamtot.step.notb)), label="tab:creamtotnotbsteplm")
@ 
...
print(xtable(summary(creamtotnotb.heldout.lm), label="tab:creamtotnotbheldout"))
@ 
...
print(xtable(summary(injtot.step.notb)), label="tab:injtotnotbsteplm")
@ 
...
print(xtable(summary(injtotnotb.heldout.lm), label="tab:injtotnotbheldout"))
@ 
...
print(xtable(summary(acutot.step.notb)), label="tab:acutotnotbsteplm")
@ 
...
print(xtable(summary(acutotnotb.heldout.lm), label="tab:acutotnotbheldout"))
@ 
...
print(xtable(summary(homtot.step.notb)), label="tab:homtotnotbsteplm")
@ 
...
print(xtable(summary(homtotnotb.heldout.lm), label="tab:homtotnotbheldout"))
@ 
...
print(xtable(summary(reitot.step.notb)), label="tab:reitotnotbsteplm")
@ 
...
print(xtable(summary(reitotnotb.heldout.lm), label="tab:reitotnotbheldout"))
@ 
...
print(xtable(summary(pilltot.step.notc)), label="tab:pilltotnotcsteplm")
@ 
...
print(xtable(summary(pilltotnotc.heldout.lm), label="tab:pilltotnotcheldout"))
@ 
...
print(xtable(summary(creamtot.step.notc)), label="tab:creamtotnotcsteplm")
@ 
...
print(xtable(summary(creamtotnotc.heldout.lm), label="tab:creamtotnotcheldout"))
@ 
...
print(xtable(summary(injtot.step.notc)), label="tab:injtotnotcsteplm")
@ 
...
print(xtable(summary(injtotnotc.heldout.lm), label="tab:injtotnotcheldout"))
@ 
...
print(xtable(summary(acutot.step.notc)), label="tab:acutotnotcsteplm")
@ 
...
print(xtable(summary(acutotnotc.heldout.lm), label="tab:acutotnotcheldout"))
@ 
...
print(xtable(summary(homtot.step.notc)), label="tab:homtotnotcsteplm")
@ 
...
print(xtable(summary(homtotnotc.heldout.lm), label="tab:homtotnotcheldout"))
@ 
...
print(xtable(summary(reitot.step.notc)), label="tab:reitotnotcsteplm")
@ 
...
print(xtable(summary(reitotnotc.heldout.lm), label="tab:reitotnotcheldout"))
@ 
...
print(xtable(summary(bamtot.step.notc)), label="tab:bamtotnotcsteplm")
@ 
...
print(xtable(summary(bamtotnotc.heldout.lm), label="tab:bamtotnotcheldout"))
@ 
...
print(xtable(summary(pilltot.step.notd)), label="tab:pilltotnotdsteplm")
@ 
...
print(xtable(summary(pilltotnotd.heldout.lm), label="tab:pilltotnotdheldout"))
@ 
...
print(xtable(summary(creamtot.step.notd)), label="tab:creamtotnotdsteplm")
@ 
...
print(xtable(summary(creamtotnotd.heldout.lm), label="tab:creamtotnotdheldout"))
@ 
...
print(xtable(summary(injtot.step.notd)), label="tab:injtotnotdsteplm")
@ 
...
print(xtable(summary(injtotnotd.heldout.lm), label="tab:injtotnotdheldout"))
@ 
...
print(xtable(summary(acutot.step.notd)), label="tab:acutotnotdsteplm")
@ 
...
print(xtable(summary(acutotnotd.heldout.lm), label="tab:acutotnotdheldout"))
@ 
...
print(xtable(summary(homtot.step.notd)), label="tab:homtotnotdsteplm")
@ 
...
print(xtable(summary(homtotnotd.heldout.lm), label="tab:homtotnotdheldout"))
@ 
...
print(xtable(summary(reitot.step.notd)), label="tab:reitotnotdsteplm")
@ 
...
print(xtable(summary(reitotnotd.heldout.lm), label="tab:reitotnotdheldout"))
@ 
...
print(xtable(summary(bamtot.step.notd)), label="tab:bamtotnotdsteplm")
@ 
...
print(xtable(summary(bamtotnotd.heldout.lm), label="tab:bamtotnotdheldout"))
@ 
...
print(xtable(pillaandbtest), label="tab:pillAandBtest")
@ 

<<ABcompprint, echo=FALSE, results=tex>>=
print(xtable(pillcanddtest, label="tab:pillCandDtest"))
@ 
...
print(summary(xtable(injtotnotd.final, label="tab:injnotdfinal")))
@ 
...
print(summary(xtable(acutotnotc.final, label="tab:acutotfinal")))
@ 
...
print(summary(xtable(homtotnotc.final, label="tab:homtotfinal")))
@ 
...
print(summary(xtable(reitotnotd.final, label="tab:reitotfinal")))
@ 
