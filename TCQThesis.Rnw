...
tcq2c5.av <- FactorAverage(sols=list(tcq2b.fact5.named, tcq2c.fact5.named), names=c("Pillinj", "Hom", "Rei", "Cream", "Acu", "Communalities"))
...
tcq2b6.coeff <- FactorCoeff(tcq2b.fact.6, names=c("Rei", "Hom", "Acu", "Cream", "Inj", "Pill"))

tcq2c6.coeff <- FactorCoeff(tcq2c.fact.6,names=c("Hom", "Rei", "Acu", "Cream", "Inj", "Pill"))
tcq2d6.coeff <- FactorCoeff(tcq2d.fact.6, names=c("Reiki", "Hom", "Acu", "Cream", "Inj", "Pill"))
tcq2.fact6.av <- (tcq2b6.coeff+tcq2c6.coeff+tcq2d6.coeff)/3
...
tcq2d.fact6.n <- FactorNames(tcq2d.fact.6,names=c("Hom", "Rei", "Acu", "Cream", "Inj", "Pill"))

tcq2.fact6.av <- FactorAverage(sols=list(tcq2b.fact6.n, tcq2c.fact6.n, tcq2d.fact6.n), names=c("Hom", "Rei", "Acu", "Cream", "Inj", "Pill", "Communalities" ))
@ 
