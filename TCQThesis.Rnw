...
itemnames <- c(pillnames, creamnames, injnames, acunames)
...
rownames(tcq4.fact.xtab) <- itemnames
...
rownames(tcq6.fact.xtab) <- itemnames
...
print(xtable(tcq2.fact7.av, label="tab:tcq2fact7average", caption="Average of Seven Factor Solutions over Splits B, C and D"), sanitize.text.function = function (x) x)
