...
tcq1.1plalt.pl <- ggplot_inf(tcqalt.grm.1pl.info)
tcq1.2plalt.pl <- ggplot_inf(tcqalt.grm.2pl.info)
print(arrangeGrob(tcq1.1plalt.pl+theme(legend.position="none"),tcq1.2plalt.pl))
@ 
...
tcq2.1plconv.pl <- ggplot_inf(tcqconv2d.grm.1pl.info)
tcq2.2plconv.pl <- ggplot_inf(tcqconv2d.grm.2pl.info)
print(arrangeGrob(tcq2.1plconv.pl+theme(legend.position="none"),tcq2.2plconv.pl+theme(legend.position=c(0.8,1))))
@
