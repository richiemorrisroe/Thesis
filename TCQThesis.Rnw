...
pcm.rasch.done <- testIRTModels(tcqconv.pcm.rasch, tcq2a.conv, constraint="rasch")
@ 


<<tcqconvpcm1pltest, echo=FALSE, results=hide>>=
pcm.1pl.done <- testIRTModels(tcqconv.pcm.1pl, tcq2a.conv, constraint="1PL")
@ 

<<tcqconvpcmgpcmtest, echo=FALSE, results=hide>>=
pcm.gpcm.done <- testIRTModels(tcqconv.pcm.gpcm, tcq2a.conv, constraint="gpcm")
@ 
