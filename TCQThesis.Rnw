...
<<tcq2dfact5, echo=FALSE, results=tex>>=
tcq2d.fact.5 <- fa(na.omit(tcqall2d), nfactors=5, rotate="oblimin", fm="pa")
print(FactorXtab(tcq2d.fact.5))
@ 
\caption{Five factor Solution, TCQ 2 (Split D), Oblimin Rotation}
\label{tab:tcq2dfivefactor}
...
Table\ref{tab:tcq2dfactorcor5}. 

<<tcq2dfactorcor5, echo=FALSE, results=tex>>=
print(FactorCor(tcq2d.fact.5))
@ 
