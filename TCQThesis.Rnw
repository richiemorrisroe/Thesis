...
print(FactorCor(tcq.fact.4, labels="factorcor4"))
@ 
...
print(FactorCor(tcq.fact.5, labels="tcq5cor"))
@ 
...
print(FactorCor(tcq.fact.6, labels="tcq6cor"))
@ 
...
print(FactorCor(tcq2a.fact.6, labels="tcq2afactorcor"))
@ 
...
print(FactorCor(tcq2a.fact.7, labels="tcq2a7factorcorr"))
@ 
...
print(FactorCor(bam2a.fact2,labels="bam2afact2cor"))
@ 
...
print(FactorCor(bam2a.fact3,labels="bam2afact3cor"))
@ 
...
print(FactorXtab(bam2a.fact4, labels="bam2afact4"))
@ 
...
print(FactorCor(bam2a.fact4,labels="bam2afact4cor"))
@ 
...
print(FactorXtab(tcq2b.fact.5, labels="tcq2afact5"))
@ 
...
print(FactorCor(tcq2b.fact.5,labels="tcq2bfactorcor5"))
@ 


<<tcq2bfact6, echo=FALSE, results=tex>>=
tcq2b.fact.6 <- fa(na.omit(tcqall2b), nfactors=6, rotate="oblimin", fm="pa")
print(FactorXtab(tcq2b.fact.6,labels="tcq2bfact6"))
@ 
\caption{Six factor Solution, TCQ 2, Oblimin Rotation}
...
print(FactorXtab(tcq2b.fact.7, labels="tcq2afact7"))
@ 
...
print(FactorCor(tcq2b.fact.7,labels="tcq2b7factorcorr"))
@ 
...
print(FactorXtab(bam2b.fact1, labels="bam2afact1"))
@ 
...
print(FactorXtab(bam2b.fact2, labels="bam2bfact2"))
@ 
...
print(FactorCor(bam2b.fact2,labels="bam2bfact2cor"))
@ 
...
print(FactorXtab(bam2b.fact3,labels="bam2bfact3"))
@ 
...
print(FactorCor(bam2b.fact3,labels="bam2bfact3cor"))
@ 
...
print(FactorXtab(bam2b.fact4,labels="bam2bfact4"))
@ 
...
print(FactorCor(bam2b.fact4,labels="bam2bfact4cor"))
@ 
...
print(FactorXtab(bam2b.fact5,labels="bam2bfact5"))
@ 
...
print(FactorCor(bam2b.fact5,labels="bam2bfact5cor"))
@ 
...
print(FactorXtab(tcq2c.fact.5,labels="tcq2cfact5"))
@ 
\caption{Five factor Solution, TCQ 2 (Split B), Oblimin Rotation}
...
print(FactorCor(tcq2c.fact.5,labels="tcq2cfactorcor5"))
@ 
...
print(FactorXtab(tcq2c.fact.6,labels="tcq2cfact6"))
@ 
\caption{Six factor Solution, TCQ 2, Oblimin Rotation}
\label{tab:tcq2.sixfactor}
...
print(FactorCor(tcq2c.fact.6,labels="tcq2cfactorcor"))
@ 
\caption{Factor Correlations, Six Factor Solution TCQ 2}
\label{tab:tcq2.sixfactorcorr}
...
print(FactorXtab(tcq2c.fact.7,labels="tcq2cfact7"))
@ 
...
print(FactorCor(tcq2c.fact.7,labels="tcq2c7factorcorr"))
@ 
...
print(FactorXtab(bam2c.fact1,labels="bam2cfact1"))
@ 
...
print(FactorXtab(bam2c.fact2,labels="bam2cfact2"))
@ 
...
print(FactorCor(bam2c.fact2,labels="bam2cfact2cor"))
@ 
...
print(FactorXtab(bam2c.fact3,labels="bam2cfact3"))
@ 
...
print(FactorCor(bam2c.fact3,labels="bam2cfact3cor"))
@ 
...
print(FactorXtab(tcq2d.fact.6,labels="tcq2dfact6"))
@ 
...
print(FactorCor(tcq2d.fact.6,labels="tcq2dfactorcor"))
@ 
...
print(FactorXtab(tcq2d.fact.7,labels="tcq2dfact7"))
@ 
...
print(FactorCor(tcq2d.fact.7,labels="tcq2d7factorcorr"))
@ 
...
print(FactorXtab(bam2d.fact1,labels="bam2dfact1"))
@ 
...
print(FactorXtab(bam2d.fact2,labels="bam2dfact2"))
@ 
...
print(FactorXtab(bam2d.fact3,labels="bam2dfact3"))
@ 
...
print(FactorCor(bam2d.fact3, labels="bam2dfact3cor"))
@ 
...
print(xtable(tcq2.notA.semcompare, labels="tab:tcq2notAsemcompare"))
@ 
...
print(xtable(bamsemcompare.notA, labels="tab:bamnotAsemcompare"))
@ 
...
print(xtable(tcq2.notB.semcompare, labels="tab:tcq2notBsemcompare"))
@ 
...
print(xtable(bamsemcompare.notB, labels="tab:bamnotBsemcompare"))
@ 
...
print(xtable(tcq2.notC.semcompare, labels="tab:tcq2notCsemcompare"))
@ 
...
print(xtable(bamsemcompare.notC, labels="tab:bamnotCsemcompare"))
@ 
...
print(xtable(tcq2.notD.semcompare, labels="tab:tcq2notDsemcompare"))
@ 
...
print(xtable(bamsemcompare.notD, labels="tab:bamnotDsemcompare"))
@ 
