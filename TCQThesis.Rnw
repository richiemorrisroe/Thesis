...
Additionally, the CEQ was found to have both cognitive and emotional factors by the authors in the paper introducing the technique~\cite{Devilly2000}. These have been shown by a systematic review to be important factors in response to placebo \cite{Blasi2001}. This theoretical link strengthened the argument for the use of this measure. 
