...
rownames(sum.coll)[1] <- "No College Supplied"
...
print(FactorXtab(tcq.fact.5, label="tab:tcq1fact5",caption="Five Factor Solution, TCQ 1 Promax rotation", label="tab:tc1fivefactor"))
@ 
...
<<grmtest, echo=FALSE, results=tex>>=
...
\begin{figure}
<<credgender, echo=FALSE, fig=TRUE>>=
...
\begin{figure}
<<collcredplot, echo=FALSE, fig=TRUE>>=
...
<<tcq2bfitindices, echo=FALSE, results=tex>>=
...
<<tcqconvguttmanplot, echo=FALSE, results=hide>>=
...
<<tcq2aaltpcm, echo=FALSE, results=hide>>=
...
%% The Partial Credit Models were all measured, but all three had serious violations of the monotonicity assumption, so the results are not shown further here. 
...
<<tcq2aaltgrm, echo=FALSE, results=hide>>=
...
<<tcq2aaltgrmtest, echo=FALSE, results=tex>>=
...
<<bampcmtest, echo=FALSE, results=tex>>=
...
<<tcq2baltpcm, echo=FALSE, results=hide>>=
...
%INSERT FIT analysis of PCM's here
%% Three partial credit models were fit to the scale, but as they all had serious problems with monotonicity, they are not discussed further here.

Next, two graded response models were fit to the data. 

<<tcq2baltgrm, echo=FALSE, results=hide>>=
...
Next, each of these model\'s performance was assessed on unseen data. 

<<tcq2baltgrmtest, echo=FALSE, results=tex>>=
...
<<tca2caltpcm, echo=FALSE, results=tex>>=
...
<<tcq2caltgrm, echo=FALSE, results=hide>>=
...
rownames(bam2c.gpcm.modcomp) <- c("Rasch PCM", "One Parameter PCM", "Two Parameter PCM")
...
<<tca2daltpcm, echo=FALSE, results=tex>>=
...
<<tcq2daltgrm, echo=FALSE, results=hide>>=
...
<<creamstepa, echo=FALSE, results=hide>>=
...
<<stepwiselmacunota, echo=FALSE, results=hide>>=
tcq2nota.full <- complete.cases(tcq2nota)
tcq2nota.complete <- tcq2nota[tcq2nota.full,]
...
<<creamstepb, echo=FALSE, results=hide>>=
...
<<pillstepc, echo=FALSE, results=hide>>=
