...
print(FactorCor(tcq2b.fact.7,label="tab:tcq2b7factorcorr"))
@ 
...
print(FactorXtab(bam2b.fact1, label="tab:bam2bfact1"))
@ 
...
print(FactorXtab(bam2b.fact2, label="tab:bam2bfact2"))
@ 
