...
\newpage
\begin{figure}
\setkeys{Gin}{height=0.9\textwidth}  
...
print(xtable(tcq2.6.average.cor, caption="Average of Factor Correlations, Six Factor Solution, TCQ2 (B,C,D)", label="tab:tcq26factorcoraverage"))
@ 
...
print(xtable(tcq2.fact7.average.cor, label="tab:tcq27factorcoraverage", caption="Averaged Factor Correlations for the Seven Factor Solution, Sample Two"))
@ 
