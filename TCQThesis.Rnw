...
<<agesummary, echo=FALSE, results=tex, cache=TRUE>>=
...
<<gendersummary, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqcollege, echo=FALSE, results=tex, cache=TRUE>>=
...
<<upgsummary, echo=FALSE, results=tex, cache=TRUE>>=
...
<<yearsummary, echo=FALSE, results=tex, cache=TRUE>>=
...
<<totalsummary, echo=FALSE, results=tex, cache=TRUE>>=
...
%% \begin{figure}
%% 	\centering
## <<scatterplotmat, echo=FALSE, fig=TRUE, cache=TRUE>>=
## sink("tmp.txt")
...
\begin{figure}
<<gendpill, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
<<collpill, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
	\centering
<<faparallel, echo=FALSE, fig=TRUE, cache=TRUE>>=
sink("tmp.txt")
...
<<tcqfact4, echo=FALSE, results=tex, cache=TRUE>>=
...
<<factorloadings4, echo=FALSE, results=verbatim, cache=TRUE>>=
print(ExtractLoadings(tcq.fact.4))
@ 


<<factorcor4, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqfact5, echo=FALSE, results=tex, cache=TRUE>>=
...
@ 
<<tcq5cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqfact6, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq6cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<fitindices,echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqscales, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqconvitemord, echo=FALSE, results=tex, cache=TRUE>>=
...
<<convmonotonicity, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqaltitemord, echo=FALSE, results=tex, cache=TRUE>>=
...
<<altmonotonicity, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqconvpcm, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqconvpcm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqconvgrmconstrained, echo=FALSE, results=tex, cache=TRUE>>=
...
The examination of the more complex model with a discrimination parameter estimated from the data (Table \ref{tab:tcqaltgpcm1pl}) shows that the acupuncture items can perhaps be modelled best with a much higher discrimination rather than higher ability estimates. An anova confirms that the 1 parameter model is a significantly better fit than the Rasch model fitted before ($p\le 0.001$). 
...
<<pilltotreg1, echo=FALSE, results=tex, cache=TRUE>>=
...
<<creamlm,echo=FALSE, results=tex, cache=TRUE>>=
...
<<injlm, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acutotlm, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq4sem2a, echo=FALSE, results=hide, cache=TRUE>>=
Pill <- "Pill"
Cream <- "Cream"
Inj <- "Inj"
Acu <- "Acu"
...
<<tcq5sem2, echo=FALSE, results=hide, cache=TRUE>>=
Pill <- "Pill"
Cream <- "Cream"
Inj <- "Inj"
Acu <- "Acu"
...
<<tcq6sem2, echo=FALSE, results=hide, cache=TRUE>>=
Pill <- "Pill"
Cream <- "Cream"
Inj <- "Inj"
Acu <- "Acu"
...
<<tcq2testsemcomp, echo=FALSE, results=tex, cache=TRUE>>=
tcq2.1.comp <- mxCompare(tcq4fit2, comparison=c(tcq5fit2, tcq6fit2))
print(xtable(summary(tcq2.1.comp), caption="Comparison of Four, Five and Six Factor Models for the TCQ1 on Sample Two", label="tab:tcq2testsemcomp"))
@ 
...
<<pilllm2a, echo=FALSE, results=tex, cache=TRUE>>=
...
<<creamlm2a, echo=FALSE, results=tex, cache=TRUE>>=
...
<<injlm2a, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acutotlm2a, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pcmmodcomp, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2demo, echo=FALSE, results=tex, cache=TRUE>>=
tcq2.demo <- tcq2[,2:17]
...
print(stargazer(tcq2.demo1, tcq2.demo2, tcq2.demo3, summary=TRUE, title="TCQ2 Summary Statistics", label="tab:tcq2sumstats"))
@ 
...
\begin{figure}
	\centering
<<tcq2pairs, echo=FALSE, fig=TRUE, cache=TRUE>>=
sink("tmp.txt")
...
\begin{figure}
<<credgender, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
<<collcredplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
	\centering
<<tcq2aparallel, echo=FALSE, fig=TRUE, cache=TRUE>>=
sink("tmp.txt")
...
<<tcq2afact6, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2afactorcor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2afact7, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamparallel, echo=FALSE, fig=TRUE, cache=TRUE>>=
sink("tmp.txt")
...
<<bam2afact1, echo=FALSE, results=tex, cache=TRUE>>=
bam2a.fact1 <- fa(na.omit(bamall2a), 1, fm="pa")
print(FactorXtab(bam2a.fact1, label="tab:bam2afact1", caption="One Factor Solution, Beliefs About Medicine Questionnaire, Sample Two"))
@ 
...
<<bam2afact2, echo=FALSE, results=tex, cache=TRUE>>=
bam2a.fact2 <- fa(na.omit(bamall2a), 2, rotate="oblimin", fm="pa")
print(FactorXtab(bam2a.fact2, label="tab:bam2afact2"))
@ 
...
<<bam2afact2cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2afact3, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2afact3cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2afact4, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2afact4cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2afact5, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2bfactorcor5, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2bfact6, echo=FALSE, results=tex, cache=TRUE>>=
tcq2b.fact.6 <- fa(na.omit(tcqall2b), nfactors=6, rotate="oblimin", fm="pa")
print(FactorXtab(tcq2b.fact.6,label="tab:tcq2bfact6",caption="Six factor Solution, TCQ 2, Oblimin Rotation"))
@ 
...
<<tcq2bfactorcor, echo=FALSE, results=tex, cache=TRUE>>=
...
As can be seen from Table \ref{tab:tcq2b6factorcor}, the correlations between factors are very similar to those between the total scores, which is perhaps unsurprising as both are linear combinations of the scores on each questions. Nonetheless, this gives supporting evidence in favour of the utility of this solution. 
...
<<tcq2bfact7, echo=FALSE, results=tex, cache=TRUE>>=
tcq2b.fact.7 <- fa(na.omit(tcqall2b), nfactors=7, rotate="oblimin", fm="pa")
print(FactorXtab(tcq2b.fact.7, label="tab:tcq2bfact7",caption="Seven Factor Solution, TCQ 2B, Oblimin Rotation"))
@ 
...
<<bam2bfact1, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bfact2, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bfact2cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bfact3, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bfact3cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bfact4, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bfact4cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bfact5, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bfact5cor, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
	\centering
<<tcq2cparallel, echo=FALSE, fig=TRUE, cache=TRUE>>=
sink("tmp.txt")
...
<<tcq2cfact5, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2cfactorcor5, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2cfact6, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2cfactorcor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2cfact7, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2c7factorcorr, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2cfitindices, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cparallel, echo=FALSE, fig=TRUE, cache=TRUE>>=
sink("tmp.txt")
...
<<bam2cfact1, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cfact2, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cfact2cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cfact3, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cfact3cor, echo=FALSE, results=tex, cache=TRUE>>=
...
\subsubsection{TCQ, Split D}
\label{sec:tcq-split-d}
...
\begin{figure}
	\centering
<<tcq2dparallel, echo=FALSE, fig=TRUE, cache=TRUE>>=
sink("tmp.txt")
par(mfrow=c(1,2))
...
<<tcq2dfact6, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2dfactorcor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2dfact7, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<bam2dparallel, echo=FALSE, fig=TRUE, cache=TRUE>>=
sink("tmp.txt")
...
<<bam2dfact1, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dfact2, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dfact2dcor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dfact3, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dfact3cor, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2notAsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamnotAsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2notBsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamnotBsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2notCsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamnotCsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2notDsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamnotDsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamallsemcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqall2semcompare, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2aitemselection, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2aconvcheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2aaltitemord, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2aconvmonotonicity, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2aaltmonotonicity, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcqaltguttmanplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
As can be seen from Figure \ref{fig:convaltguttman} and \ref{fig:altguttman}, the majority of participants had zero guttman errors, which indicates that they were responding to the scale in a coherent manner. 
...
<<tcq2acoefrasch, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2acoefpcm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2acoefgpcm, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2aconvgrm1plsumm, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2aconvgrm1plPlot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
<<tcq2aconvgrm2plPlot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2aconvpcmtest, echo=FALSE, results=hide, cache=TRUE>>=
...
<<tcq2aaltgpcmrasch, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2aaltgpcm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2agrm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2agrm2pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2aaltgrmtest, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2ascales, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2aiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2acheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2arasch, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2a1PL, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2agpcm, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2agrm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2agrm2pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2baisp, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2bcheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2bconvcheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2baltcheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2baltcheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2bconvgpcmraschplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
<<tcq2bconvgpcm1PLplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
<<tcq2bconvgpcmgpcmplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2bconvpcmraschprint, echo=FALSE, results=tex, cache=TRUE>>=
...
As can be seen from Table \ref{tab:tcq2bprcmrasch}, the issues with category three are apparent again with this split, suggesting that it was being used as a default response choice by many of the participants. Again, the cream items have the highest thresholds, while the Injection items have the lowest. 

Next, we examine the coefficients for a one parameter PCM. 

<<tcq2bconvpcm1plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2bconvpcm2plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2bconvgrm1plot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2bconvgrm1plsumm, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2bconvgrm2plot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2bconv2plgrmsum, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2baltpcmraschprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2baltpcm1plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2baltpcm2plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
@ 
<<tcq2baltgrm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2baltgrm2pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2baisp, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamscale2b,echo=FALSE, results=hide, cache=TRUE>>=
...
<<bam2checkiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bcheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<bam2bguttman, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<bam2bgpcmrasch, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bgpcm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bgpcmgpcm, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bgrm1sum, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2bgrm2sum, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2caisp, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2ccheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2cconvcheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2cconvguttman, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2caltcheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2caltcheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2cconvgpcmraschplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2cgpcmraschprint, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2cconvgpcm1PLplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2cconvgpcm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2cconvgpcmgpcmplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2cconvgpcmgpcm, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2cconvgrm1plot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2cconvgrm1plsumm, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2cconvgrm2plot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2cconv2plgrmsum, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2caltgpcmrasch, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2caltgpcm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2caltgpcmgpcm, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2caltgrm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2caltgrm2pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2caisp, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2ccheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2ccheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<bam2cguttman, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<bam2cgpcmrasch, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cpcm1plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cgpcmgpcmprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cgrm1sum, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2cgrm2sum, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2daisp, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2dcheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2dconvcheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvguttman, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2daltcheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2daltcheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2dconvgpcm, echo=FALSE, results=hide, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvgpcmraschplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2dconvgpcmraschprint, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvgpcm1PLplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2dgpcm1plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvgpcmgpcmplot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2dconvgpcmgpcmprint, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvgrm1plot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2dconvgrm1plsumm, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvgrm2plot, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<tcq2dconv2plgrmsum, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2daltpcmraschprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2daltpcm1plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2daltpcmgpcmprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2daltgrm1pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2daltgrm2pl, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2daisp, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dcheckiio, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dcheckmono, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<bam2dguttman, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<bam2dgpcmrasch, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dpcm1plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dpcm2plprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dgrm1sum, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bam2dgrm2sum, echo=FALSE, results=tex, cache=TRUE>>=
...
\begin{figure}
<<splitApairs, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
<<convaltmeans, echo=FALSE, results=hide, cache=TRUE>>=
...
\begin{figure}
<<ggplotconvaltcollege, echo=FALSE,figure=TRUE , cache=TRUE>>=
...
\begin{figure}
<<medhealthyear, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
\begin{figure}
<<ggplotpillincome, echo=FALSE, figure=TRUE , cache=TRUE>>=
p <- ggplot(na.omit(tcq2nota), aes(x=ConvMean, y=AltMean))
...
\begin{figure}
<<expconvaltgender, echo=FALSE, fig=TRUE, cache=TRUE>>=
...
<<steppilla, echo=FALSE, results=tex, cache=TRUE>>=
...
<<lmonheldoutdata, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pill2alassoprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pill2aridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<creamstepa, echo=FALSE, results=hide, cache=TRUE>>=
...
<<lmonheldoutdatacream, echo=FALSE, results=tex, cache=TRUE>>=
...
<<cream2alasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<cream2aridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<injstepa, echo=FALSE, results=tex, cache=TRUE>>=
...
<<lmonheldoutdatainj, echo=FALSE, results=tex, cache=TRUE>>=
...
<<inj2alasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<inj2aridge, echo=FALSE, results=tex, cache=TRUE>>=
inj2a.ridge <- penalisedRegression(predinj2a, inj2a, predinj2a.test, inj2a.test, alpha=0, type="coefficients")
print(xtable(as.matrix(inj2a.test), label="tab:inj2aridge", caption="Coefficient Estimates, Injection Credibility Ridge Regression Model, Split A"))
@ 

Table \ref{tab:inj2aridge} shwos the estimated coefficients for the ridge regression model Injection credibility scores. It can be seen that the model is quite similar to that obtained from the lasso regression, even the coefficients are of similar magnitude. 
...
<<acustepa, echo=FALSE, results=tex, cache=TRUE>>=
...
<<lmonheldoutdataacu, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acu2alasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acu2aridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<stepwiselm, echo=FALSE, results=tex, cache=TRUE>>=
tcq2nota.full <- complete.cases(tcq2nota)
tcq2nota.complete <- tcq2nota[tcq2nota.full,]
...
<<hom2alasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<hom2aridge, echo=FALSE, results=tex, cache=TRUE>>=
...
Table \ref{tab:tcq2ahomridge} shows the estimated coefficients from the ridge model. Iy can be seen that these are extremely similar to those obtained from the lasso model, suggesting that these coefficients are associated with the response variable in this sample. 
...
<<rei2alasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<rei2aridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<lmonheldoutdatabam, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pilltotlmnotb, echo=FALSE, results=hide, cache=TRUE>>=
...
<<pillstepb, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pilltotnotbheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pill2blasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pill2bridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<creamtotlmnotb, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notb.full <- complete.cases(tcq2notb)
tcq2notb.complete <- tcq2notb[tcq2notb.full,]
...
<<creamstepb, echo=FALSE, results=hide, cache=TRUE>>=
...
<<creamtotnotbheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<cream2blasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<cream2bridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<injtotlmnotb, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notb.full <- complete.cases(tcq2notb)
tcq2notb.complete <- tcq2notb[tcq2notb.full,]
...
<<injtotnotbheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<inj2blasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acutotlmnotb, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notb.full <- complete.cases(tcq2notb)
tcq2notb.complete <- tcq2notb[tcq2notb.full,]
...
<<acustepb, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acutotnotbheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acu2blasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acu2bridge, echo=FALSE, results=tex, cache=TRUE>>=
...
It can be seen from Table \ref{tabtcq2bacuridge} that the ridge repression is quite similar to the lasso fit. Interestingly enough, pilltotal did not get shrunk as much in this model and shows a negative correlation with Acupuncture credibility (as would be expected). The strange positive correlation with Cream credibility remains.
...
<<homtotlmnotb, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notb.full <- complete.cases(tcq2notb)
tcq2notb.complete <- tcq2notb[tcq2notb.full,]
...
<<homstepb, echo=FALSE, results=tex, cache=TRUE>>=
...
<<homtotnotbheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<hom2blasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<hom2bridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<reitotlmnotb, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notb.full <- complete.cases(tcq2notb)
tcq2notb.complete <- tcq2notb[tcq2notb.full,]
...
<<reistepb, echo=FALSE, results=tex, cache=TRUE>>=
...
<<reitotnotbheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<rei2blasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<rei2bridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pilltotlmnotc, echo=FALSE, results=hide, cache=TRUE>>=
...
<<pillstepc, echo=FALSE, results=hide, cache=TRUE>>=
...
<<pill2classo, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pill2cridge, echo=FALSE, results=tex, cache=TRUE>>=
...
Table \ref{tcq2cpillridge} shows the estimated coefficients for the ridge model, and there are quite similar to those of the lasso model. 


<<creamtotlmnotc, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notc.full <- complete.cases(tcq2notc)
tcq2notc.complete <- tcq2notc[tcq2notc.full,]
...
<<creamstepc, echo=FALSE, results=tex, cache=TRUE>>=
...
<<cream2classo, echo=FALSE, results=tex, cache=TRUE>>=
...
<<cream2cridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<injtotlmnotc, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notc.full <- complete.cases(tcq2notc)
tcq2notc.complete <- tcq2notc[tcq2notc.full,]
...
<<injstepc, echo=FALSE, results=tex, cache=TRUE>>=
...
<<inj2classo, echo=FALSE, results=tex, cache=TRUE>>=
...
<<inj2cridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acutotlmnotc, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notc.full <- complete.cases(tcq2notc)
tcq2notc.complete <- tcq2notc[tcq2notc.full,]
...
<<acustepc, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acu2classo, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acu2cridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<homtotlmnotc, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notc.full <- complete.cases(tcq2notc)
tcq2notc.complete <- tcq2notc[tcq2notc.full,]
...
<<homstepc, echo=FALSE, results=tex, cache=TRUE>>=
...
<<hom2classo, echo=FALSE, results=tex, cache=TRUE>>=
...
<<hom2cridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<reitotlmnotc, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notc.full <- complete.cases(tcq2notc)
tcq2notc.complete <- tcq2notc[tcq2notc.full,]
...
<<reistepc, echo=FALSE, results=tex, cache=TRUE>>=
...
<<rei2classo, echo=FALSE, results=tex, cache=TRUE>>=
...
<<rei2cridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamtotlmnotc, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notc.full <- complete.cases(tcq2notc)
tcq2notc.complete <- tcq2notc[tcq2notc.full,]
...
<<bamtotnotbheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pilltotlmnotd, echo=FALSE, results=hide, cache=TRUE>>=
...
<<pillstepd, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pill2dlasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<pill2dridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<creamtotlmnotd, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notd.full <- complete.cases(tcq2notd)
tcq2notd.complete <- tcq2notd[tcq2notd.full,]
...
<<creamstepd, echo=FALSE, results=tex, cache=TRUE>>=
...
<<cream2dlasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<cream2dridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<injtotlmnotd, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notd.full <- complete.cases(tcq2notd)
tcq2notd.complete <- tcq2notd[tcq2notd.full,]
...
<<injstepd, echo=FALSE, results=tex, cache=TRUE>>=
...
<<inj2dlasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<inj2dridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acutotlmnotd, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notd.full <- complete.cases(tcq2notd)
tcq2notd.complete <- tcq2notd[tcq2notd.full,]
...
<<acustepd, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acutotnotdheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acu2dlasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acu2dridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<homtotlmnotd, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notd.full <- complete.cases(tcq2notd)
tcq2notd.complete <- tcq2notd[tcq2notd.full,]
...
<<homstepd, echo=FALSE, results=tex, cache=TRUE>>=
...
<<hom2dlasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<hom2dridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<reitotlmnotd, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notd.full <- complete.cases(tcq2notd)
tcq2notd.complete <- tcq2notd[tcq2notd.full,]
...
<<reikinotd, echo=FALSE, results=tex, cache=TRUE>>=
...
<<reitotnotdheldout, echo=FALSE, results=tex, cache=TRUE>>=
...
<<rei2dlasso, echo=FALSE, results=tex, cache=TRUE>>=
...
<<rei2dridge, echo=FALSE, results=tex, cache=TRUE>>=
...
<<bamtotlmnotd, echo=FALSE, results=hide, cache=TRUE>>=
tcq2notd.full <- complete.cases(tcq2notd)
tcq2notd.complete <- tcq2notd[tcq2notd.full,]
...
<<bamstepd, echo=FALSE, results=tex, cache=TRUE>>=
...
<<tcq2new, echo=FALSE, results=hide, cache=TRUE>>=
set.seed(23)
...
<<pillfinalfits, echo=FALSE, results=hide, cache=TRUE>>=
...
<<ABcompprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<creamfinal, echo=FALSE, results=hide, cache=TRUE>>=
...
<<injfinal, echo=FALSE, results=hide, cache=TRUE>>=
...
<<modeldshow, echo=FALSE, results=tex, cache=TRUE>>=
...
<<acufinaltest, echo=FALSE, results=hide, cache=TRUE>>=
...
<<acutotfinalprint, echo=FALSE, results=tex, cache=TRUE>>=
...
<<hommodfinal, echo=FALSE, results=tex, cache=TRUE>>=
...
<<homfinalshow, echo=FALSE, results=tex, cache=TRUE>>=
...
<<reikimodfinal, echo=FALSE, results=hide, cache=TRUE>>=
...
<<reifinalshow, echo=FALSE, results=tex, cache=TRUE>>=
...
<<saveimage, echo=FALSE, results=hide, cache=TRUE>>=
