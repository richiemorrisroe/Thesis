...
\begin{figure}
<<gendpill, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<collpill, echo=FALSE, figure=TRUE>>=
grid.arrange(arrangeGrob(collpill, collcream, collinj, collacu))+theme(axis.text.x=element_text(angle=45, hjust=1))
@   
...
\begin{figure}
	\centering
<<faparallel, echo=FALSE, figure=TRUE>>=
sink("tmp.txt")
...
@ 
<<tcqconv2plprint, echo=FALSE, results=hide>>=
...
@ 
<<tcaltgrm1plprint, echo=FALSE, results=hide>>=
...
\begin{figure}
	\centering
<<tcq2pairs, echo=FALSE, figure=TRUE>>=
sink("tmp.txt")
...
\begin{figure}
<<credgender, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<collcredplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
	\centering
<<tcq2aparallel, echo=FALSE, figure=TRUE>>=
sink("tmp.txt")
...
<<bamparallel, echo=FALSE, figure=TRUE>>=
sink("tmp.txt")
...
\begin{figure}
	\centering
<<tcq2cparallel, echo=FALSE, figure=TRUE>>=
sink("tmp.txt")
...
\begin{figure}
<<bam2cparallel, echo=FALSE, figure=TRUE>>=
sink("tmp.txt")
...
\begin{figure}
	\centering
<<tcq2dparallel, echo=FALSE, figure=TRUE>>=
sink("tmp.txt")
par(mfrow=c(1,2))
...
\begin{figure}
<<bam2dparallel, echo=FALSE, figure=TRUE>>=
sink("tmp.txt")
...
<<tcqaltguttmanplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2aconvgrm1plPlot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2aconvgrm2plPlot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2bconvgpcmraschplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2bconvgpcm1PLplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2bconvgpcmgpcmplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2bconvgrm1plot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2bconvgrm2plot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<bam2bguttman, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2cconvguttman, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2cconvgpcmraschplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2cconvgpcm1PLplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2cconvgpcmgpcmplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2cconvgrm1plot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2cconvgrm2plot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<bam2cguttman, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2dconvguttman, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2dconvgpcmraschplot, echo=FALSE, figure=TRUE>>=
...
\begin{figure}
<<tcq2dconvgpcm1PLplot, echo=FALSE, figure=TRUE, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvgpcmgpcmplot, echo=FALSE, figure=TRUE, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvgrm1plot, echo=FALSE, figure=TRUE, cache=TRUE>>=
...
\begin{figure}
<<tcq2dconvgrm2plot, echo=FALSE, figure=TRUE, cache=TRUE>>=
...
\begin{figure}
<<bam2dguttman, echo=FALSE, figure=TRUE, cache=TRUE>>=
...
\begin{figure}
<<splitApairs, echo=FALSE, figure=TRUE, cache=TRUE>>=
...
\begin{figure}
<<medhealthyear, echo=FALSE, figure=TRUE, cache=TRUE>>=
...
\begin{figure}
<<expconvaltgender, echo=FALSE, figure=TRUE, cache=TRUE>>=
