...
Typically, the five factor solution merged the Pill credibility and Injection credibility items together, and this pattern was repeated across both splits. The results of the averaged factor solutions from Splits B and C is shown in Table \ref{tab:tcq2fact5average}. 
