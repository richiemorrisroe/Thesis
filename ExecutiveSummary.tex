...
% The results showed that the treatment credibility IAT was a significant (p=0.02) predictor of the placebo response, as assessed with a logistic regression. 
...
\bibliography{placebo2,IAT2,healthoptmind2,statistics} 
\end{document}
