...
tcqmodels <- new.env()
load("~/Thesis/Health Data for R/healthforthesis.rda", envir=healthmodels)
...
placmod1 <- glm(PlacResp~tcqiatscore, data=expmeasureswithirt, family=binomial(link="logit"))
