...
f=open("tcqpart5234comma3", "r")
partline=re.compile("Participant") #get participant line, do actions
stupidunicodesearch=re.compile("\xef\xbb\xbf")
...
headers={"Participant":"Participant", "Date":"Date", "Time":"Time", "Block":"Block", "Inaccurate":"Inaccurate", "Fake":"Fake", "Illusory":"Illusory", "Lies":"Lies", "Accurate":"Accurate", "Truth":"Truth", "Actual":"Actual", "Real":"Real", "Acupuncture":"Acupuncture", "Reiki":"Reiki", "FlowerEssence":"FlowerEssence", "Homeopathy":"Homeopathy", "Surgery":"Surgery", "Injections":"Injections", "Pills":"Pills", "Cream":"Cream", "Correct":"Correct", "BlockTime":"BlockTime"}
fout=open("tcq5234res.csv", "w")
...
for line in f:
    if  re.search(partline, line): #search not match because of stupid unicode
      if re.match(stupidunicodesearch, line):
        line=re.sub(stupidunicodesearch, "", line)
      line=line.rstrip()
