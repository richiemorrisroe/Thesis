...
Primarily, direct oblimin methods of rotations were utilised, but promax rotations were also applied where these failed to converge. In general, promax will attempt to find the rotations which maximise simple structure~\cite{hendrickson1964promax}. 
