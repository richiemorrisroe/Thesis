...
This was then administered to a small sample (N=17) to test the instrument. 
 The results of this testing are described in Chapter~\ref{cha:devel-impl-meas}, in Section~\ref{sec:ill-find-something-to-put-here}.
...
%moved from TCQ chapter, expand this and make it make sense. 
