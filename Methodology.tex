...
Following the investigation of structure with the methods of classical test theory, the scales were analysed using Rasch models and item response theory (using functions from the ltm package~\cite{ltm2006}). Firstly, Mokken analyses (from the Mokken package~\cite{vanderark2012}) were run, in order to check the assumptions of monotonicity, local independence and to assess how many sub-scales the analysis should be carried out on. 
