...
Table~\ref{tab:tcq1rand8fact} on page \pageref{tab:tcq1randfact8} shows the loadings and has the named factors for the eight factor solution. 
...
The factor correlations are moderate ($r=0.1-0.5$) and in line with expectations. 
