...
<<optstep, echo=FALSE, results=tex>>=
...
print(xtable(summary(opt.step), caption="Coefficients for Stepwise Selected Model on Test Data", caption="tab:homstepopttest2a"))
@ 
