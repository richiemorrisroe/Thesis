...
print(FactorXtab(rand.fact.8, names=c( "PhysFunc", "SocEmWB", "GenHealth", "EmRoleLim", "RoleLim", "Fatigue","Pain", "Energy"), label="tab:tcq1rand8fact", caption="factor Loadings Eight Factor Solution, RAND MOS, Sample One"))
@
...
print(FactorXtab(lotr.fact.2,label="tab:tcq1lotr2fact", caption="Factor Loadings, Two Factor Solution, LOT-R, Sample One"))
@
...
opt.lasso.test2b <- penalisedRegression(x=opt.pred.train2b, y=opt.train2b, traindata=opt.pred.train2b, testdata=opt.pred.test2b, newy=opt.test2b, alpha=1, nfolds=10, type="coefficients")
opt.lasso.test2b.pred <- penalisedRegression(x=opt.pred.train2b, y=opt.train2b, traindata=opt.pred.train2b, testdata=opt.pred.test2b, newy=opt.test2b, alpha=1, nfolds=10, type="response")
...
opt.lasso.test2b.resp <- penalisedRegression (x=opt.pred.train2b, y=opt.train2b, traindata=opt.pred.train2b, testdata=opt.pred.test2b, newy=opt.test2b, alpha=1, nfolds=10, type="response")
@ 
...
opt.ridge.test2b <- penalisedRegression(x=opt.pred.train2b, y=opt.train2b, traindata=opt.pred.train2b, testdata=opt.pred.test2b, newy=opt.test2b, alpha=1, nfolds=10, type="coefficients")
opt.ridge.test2b.pred <- penalisedRegression(x=opt.pred.train2b, y=opt.train2b, traindata=opt.pred.train2b, testdata=opt.pred.test2b, newy=opt.test2b, alpha=1, nfolds=10, type="response")
...
opt.ridge.test2b.resp <- penalisedRegression (x=opt.pred.train2b, y=opt.train2b, traindata=opt.pred.train2b, testdata=opt.pred.test2b, newy=opt.test2b, alpha=1, nfolds=10, type="response")
@ 
