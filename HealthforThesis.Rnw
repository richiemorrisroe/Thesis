...
Scale 2: RANDQ17-RANDQ19,24-25,28-32,25. This scale incorporates the Role Limitations, Social Functioning, Emotional Well Being and Energy scales, and can best be termed as Negative Health.
...
<<emhealthpcm, echo=FALSE, results=hide>>=
emhealth.pcm.rasch <- gpcm(irtemhealth2.2, constraint="rasch")
emhealth.pcm.1PL <- gpcm(irtemhealth2.2, constraint="1PL")
emhealth.pcm.gpcm <- gpcm(irtemhealth2.2, constraint="gpcm")
@ 
