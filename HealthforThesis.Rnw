...
The primary aim of this part of thesis was both to replicate the optimism-health link reported in previous studies, to examine the relationship between health and mindfulness and to develop and test psychometric models that could be used to predict scores according to IRT and factor analysis criteria in the experimental part of the research, therefore both factor analytic and item response models were fit to the optimism and mindfulness scales. 
...
The first 392 participants completed the forms by hand between August and October 2009. The participants were sampled pseudo-randomly from all of the public areas (coffee shops, restaurants etc) of the campus.
...
@ 
As can be seen from Table \ref{tab:hom1healthsteptest}, optimism, role limitations and energy fatigue were retained as predictors in the model. None of the variables were significant, however. 
...
PA1: "RANDQ1",  "RANDQ14", "RANDQ16" ,"RANDQ17" ,"RANDQ18" ,"RANDQ19" ,"RANDQ20" ,"RANDQ21" ,"RANDQ22" ,"RANDQ23" ,"RANDQ24" ,"RANDQ25" ,"RANDQ26" ,"RANDQ27","RANDQ28" ,"RANDQ29" ,"RANDQ30" ,"RANDQ31" ,"RANDQ32" ,"RANDQ33" ,"RANDQ34"
,"RANDQ35" ,"RANDQ36". 
...
\begin{figure}
<<pairsplot2, echo=FALSE, fig=TRUE>>=
scales2 <- hom2[,66:75]
