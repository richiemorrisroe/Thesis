...
<<opttrain, echo=FALSE, results=hide, eval=FALSE>>=
...
testpred <- hom1.test.opt[,c("pain", "mindfulness", "socialfunctioning", "rolelim", "rolelimem", "emwellbeing", "physfun", "energyfat")]
...
trainpred <- hom1.train.opt[,66:74]
