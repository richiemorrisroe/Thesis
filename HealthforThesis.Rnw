...
%% It is surprising that optimism has not been investigated as a predictor of the placebo response before, given that the creators of the LOT-R describe optimism as ``generalised positive expectancies around the future''. \cite{Carver2010} This definition would seem to share some similarities with the definition of optimism used by Kirsch and other researchers in the field. 
...
%% \begin{figure}
## <<optlassopredplot, echo=FALSE, results=hide, cache=TRUE>>=
...
@
<<retainfactors, echo=FALSE, results=hide, cache=TRUE>>=
sink("tmp.txt")
...
<<randfactorcv, echo=FALSE, results=hide, cache=TRUE>>=
...
<<retainmaas, echo=FALSE, results=hide, cache=TRUE>>=
sink("tmp.txt")
...
<<retainlotr, echo=FALSE, results=hide, cache=TRUE>>=
...
<<mapall, echo=FALSE, results=hide, cache=TRUE>>=
...
<<maas7sem, echo=FALSE, results=hide, cache=TRUE>>=
maas <- "MAASQ"
...
<<lotrranddirect, echo=FALSE, results=hide, eval=FALSE>>=
...
<<opthealthmaaasmdediated, echo=FALSE, results=hide, cache=TRUE>>=

opt.health.indirect.maas <- mxModel(lotr.rand.direct, mxPath(from=predictors, to=response), remove=TRUE)
rand.lotr.indirect.done <- mxModel(opt.health.indirect,
...
<<randindirectemwelleing, echo=FALSE, results=hide, cache=TRUE>>=
...
<<lotrindirectenergyfat, echo=FALSE, results=hide, cache=TRUE, eval=FALSE>>=
...
<<lotrindirectgenhealth, echo=FALSE, results=hide, cache=TRUE, eval=FALSE>>=
...
<<maas2bparallel, echo=FALSE, fig=TRUE, results=hide, cache=TRUE>>=
...
<<maas2cparallel, echo=FALSE, fig=TRUE, results=hide, cache=TRUE>>=
