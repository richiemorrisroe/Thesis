...
print(xtable(coefirt(lotr.pcm.2pl,se=TRUE),label="tab:lotr2plestimates", caption="Coefficient Estimates for LOTR Two Parameter Graded Response Model"), sanitize.colnames.function=function (x) x,scalebox=0.7)
@
