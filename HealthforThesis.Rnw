...
hom1.lotr.grm.1pl.test <- testIRTModels(hom1.lotr.grm.1pl, lotr.irt2a, gpcmconstraint=NULL, grmconstraint=TRUE)
hom1.lotr.grm.2pl.test <- testIRTModels(hom1.lotr.grm.2pl, lotr.irt2a, gpcmconstraint=NULL, grmconstraint=FALSE)
...
print(xtable(hom1.lotr.grm.all, caption="Performance of LOTR One and Two Parameter GRM's on Unseen Data (Sample Two, Split A)"))
@ 
