...
print(xtable(randsemcomp,label="tab:randsemcomparehom2", caption="Model Comparison for RAND MOS data using Models from Sample 1 on Sample 2" ), scalebox=0.6)
@
...
print(maascomp.xtab2, scalebox=0.7)
@
...
\begin{figure}
<<optridgeplot2a, echo=FALSE, fig=TRUE>>=
...
Firstly, the demographics of the sample were examined. 

<<hom2demo, echo=FALSE, results=tex>>=
demo <- hom2[,3:7]
sum.demo <- summary(demo)
print(xtable(sum.demo, label="tab:sumdemo2", caption="Demographics of Sample Two"), scalbeox=0.8)
@ 
