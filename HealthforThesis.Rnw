...
maasitems.red2 <- paste0(maas, c(1:4, 6:10, 12:15))
...
As can be seen from Table \ref{tab:maasbacktestsemcompare}, the reduced model without questions 5 and 6 provided the best fit to the unseen data. 
