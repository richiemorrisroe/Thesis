...
print(xtable(maasquestions, caption="tab:maasitems", label="MAAS Item Content"))
@ 
...
cors <- scale.cor$r
print(xtable(as.data.frame(cors), label="tab:hom2scalecor", environment="longtable",  caption="Spearman Correlations between Scale Totals across both Samples" ),)
@ 
