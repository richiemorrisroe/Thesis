...
randscored1 <- myscrub(rand.set1, isvalue=c(1,2,3,4,5), newvalue=c(100,75,50,25,0))
paste2 <- paste(rand, 3:12, sep="")
randset2 <- randitems[,paste2]
randscored2 <- myscrub(randset2, isvalue=c(1,2,3), newvalue=c(0,50,100))
paste3 <- paste(rand, 13:19, sep="")
randset3 <- randitems[,paste3]
randscored3 <- myscrub(randset3, isvalue=c(1,2), newvalue=c(0,100))
...
randscored4 <- myscrub(randset4, isvalue=c(1,2,3,4,5), newvalue=c(100,80,60,40,20))
randscored4 <- myscrub(randscored4, isvalue=6, newvalue=0)
randscored5 <- myscrub(randset5, isvalue=c(1,2,3,4,5), newvalue=c(0,20,40,60,80))
randscored5 <- myscrub(randscored5, isvalue=6, newvalue=100)
y <- c(32,33,35)
paste6 <- paste(rand, y, sep="")
randset6 <- randitems[,paste6]
randscored6 <- myscrub(randset6, isvalue=c(1,2,3), newvalue=c(0,25,50))
randscored6 <- myscrub(randscored6, isvalue=c(4,5), newvalue=c(75,100))
...
irtphysfunct.scaled <- myscrub(irtphysfunct, isvalue=c(0,50,100), newvalue=c(0,1,2))
@
...
print(IrtXtab(physfun.PCM,label="tab:tcq1physfunrasch"))
@
