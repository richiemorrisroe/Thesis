...
It can be seen from Table \ref{tab:lotrfactgabriel} that the Wold method of cross-validation suggests that there are three factors which underlie this scale. This seems relatively implausible, but it will be tested. 
...
print(xtable(maas.fact.1$r.scores,label="tab:tcq1maas1corr"))
@
...
print(xtable(lotr.fact.1$r.scores,label="tab:tcq1lotr1corr"))
@
...
print(FactorXtab(lotr.fact.2,label="tab:tcq1lotr2fact"))
@
...
print(xtable(lotr.fact.2$r.scores,,label="tab:tcq1lotr2corr"))
@
...
rand.scales <- aisp(na.omit(randitems.scored))
@
...
irtphysfun <- randitems.scored[,paste(rand, c(3:12), sep="")]
irtemhealth <- randitems.scored[,paste(rand, c(17:20, 23:32), sep="")]
irtpain <- randitems.scored[,paste(rand, c(21:22), sep="")]
irtgenhealth <- randitems.scored[,paste(rand, c(1, 33, 34, 36), sep="")]
@
...
irtEmhealth2 <- randitems.scored[,paste(rand, c(17, 20, 23:24, 26:32), sep="")]
...
print(xtable(emhealth.item.ord2$violations,,label="tab:tcq1emhealth2itemord"))
@
...
rand13pred <- predict.psych(rand.fact13, randitems2)
