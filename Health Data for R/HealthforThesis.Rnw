...
randscored1 <- scrub(rand.set1, where=c(1:5), isvalue=c(1,2,3,4,5), newvalue=c(100,75,50,25,0))
...
irtphysfunct.scaled <- scrub(irtphysfunct, isvalue=c(0,50,100), newvalue=c(1,2,3))
@
